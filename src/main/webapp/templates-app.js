angular.module('templates-app', ['about/about.tpl.html', 'bootstraptest/bootstraptest.tpl.html', 'bootstraptest/buttontest.tpl.html', 'bootstraptest/gridtest.tpl.html', 'bootstraptest/phototest.tpl.html', 'home/home.tpl.html', 'orderform/orderform.confirm.tpl.html', 'orderform/orderform.step1.tpl.html', 'orderform/orderform.step2.tpl.html', 'orderform/orderform.tpl.html']);
...
angular.module("bootstraptest/bootstraptest.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("bootstraptest/bootstraptest.tpl.html",
    "<div class=\"row\">\n" +
    "  <h1 class=\"page-header\">\n" +
    "    Bootstrap test\n" +
    "    <small>What can we do with bootstrap</small>\n" +
    "  </h1>\n" +
    "\n" +
    "\n" +
    "</div>\n" +
...
angular.module("bootstraptest/buttontest.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("bootstraptest/buttontest.tpl.html",
    "<div class=\"row\">\n" +
    "    <h1 class=\"page-header\">\n" +
    "        Bootstrap test\n" +
    "        <small>What can we do with bootstrap</small>\n" +
    ...
    "            <button class=\"btn btn-primary\" type=\"submit\">Primay</button>\n" +
...
angular.module("bootstraptest/gridtest.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("bootstraptest/gridtest.tpl.html",
    "<div class=\"row\">\n" +
    "    <h1 class=\"page-header\">\n" +
    "        Bootstrap\n" +
    "        <small>What can we do with bootstrap</small>\n" +
    ...
    "        <div class=\"row\">\n" +
    "            <div class=\"col-md-3 col-xs-12\">Info over grids</div>\n" +
    "            <div class=\"col-md-3 col-xs-12\"><a href=\"http://getbootstrap.com/css/#grid\">Bootstrap grid system</a></div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    "\n" +
    ...
    "\n" +
    "    <div class=\"container-fluid\">\n" +
    "        <!--3 xs kolommmen naast elkaar kan niet, worden daarom op mobiel gestackt-->\n" +
    "        <div class=\"row\">\n" +
    "            <div class=\"col-xs-6 col-md-4\">Col 1</div>\n" +
    "            <div class=\"col-xs-6 col-md-4\">Col 2</div>\n" +
    "            <div class=\"col-xs-6 col-md-4\">Col 3 (stacked on mobile)</div>\n" +
    "        </div>\n" +
    "\n" +
    "        <!--Skip column-->\n" +
    "        <div class=\"row\">\n" +
    "            <div class=\"col-xs-offset-6 col-xs-6 col-md-offset-4 col-md-4\">Skip col 1</div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
    "    <h1 class=\"page-header\">\n" +
...
angular.module("bootstraptest/phototest.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("bootstraptest/phototest.tpl.html",
    "<div class=\"row\">\n" +
    "\n" +
    "    <img src=\"assets/DSC_0013.jpg\" class=\"img-responsive\" alt=\"Responsive image\">\n" +
    "\n" +
    "    <h1 class=\"page-header\">\n" +
    "        Bootstrap\n" +
    "        <small>What can we do with bootstrap</small>\n" +
...
angular.module("orderform/orderform.confirm.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("orderform/orderform.confirm.tpl.html",
    "<div class=\"panel panel-default rounded\">\n" +
    "    <div class=\"panel-heading\">\n" +
    "        <h1 class=\"panel-title\">Order your success!</h1>\n" +
    "        <small>Confirm</small>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"panel-body\">\n" +
    "        <form>\n" +
    "            <div class=\"row\" ng-if=\"order.p1\">\n" +
    "                <div class=\"col-xs-offset-2 col-sm-offset-3\">\n" +
    "                    Succes in de liefde\n" +
    "                </div>\n" +
    "            </div>\n" +
    "            <div class=\"row\" ng-if=\"order.p2\">\n" +
    "                <div class=\"col-xs-offset-2 col-sm-offset-3\">\n" +
    "                    Succes in het werk\n" +
    "                </div>\n" +
    "            </div>\n" +
    "            <div class=\"row\" ng-if=\"order.p3\">\n" +
    "                <div class=\"col-xs-offset-2 col-sm-offset-3\">\n" +
    "                    Financieel succes\n" +
    "                </div>\n" +
    "            </div>\n" +
    ...
    "\n" +
    "    <div class=\"row\">\n" +
    "        <div class=\"col-xs-offset-1 col-sm-offset-3 col-xs-11 col-sm-9\">\n" +
    "            <button type=\"submit\" ng-click=\"back()\" class=\"btn btn-lg btn-success\"><< Back</button>\n" +
    "            <button type=\"submit\" ng-click=\"confirm()\" class=\"btn btn-lg btn-success\">Confirm</button>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    </form>\n" +
    "</div>\n" +
...
angular.module("orderform/orderform.step1.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("orderform/orderform.step1.tpl.html",
    "<div class=\"panel panel-default rounded\">\n" +
    "    <div class=\"panel-heading\">\n" +
    "        <h1 class=\"panel-title\">Order your success!</h1>\n" +
    "        <small>Step 1</small>\n" +
    ...
    "                    <div class=\"checkbox\">\n" +
    "                        <label>\n" +
    "                            <input type=\"checkbox\" value=\"\" ng-model=\"order.p1\">\n" +
    "                            Succes in de liefde\n" +
    "                        </label>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                        <label>\n" +
    "                            <input type=\"checkbox\" value=\"\" ng-model=\"order.p2\">\n" +
    "                            Succes in het werk\n" +
    "                        </label>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                    <div class=\"checkbox disabled\">\n" +
    "                        <label>\n" +
    "                            <input type=\"checkbox\" value=\"\" ng-model=\"order.p3\">\n" +
    "                            Financieel succes\n" +
    "                        </label>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "\n" +
    "            <div class=\"row\">\n" +
    "                <div class=\"col-xs-offset-2 col-sm-offset-3 col-xs-3 col-sm-1\">\n" +
    "                    <button type=\"submit\" ng-click=\"next()\" ng-show=\"isValidOrder()\" class=\"btn btn-lg btn-success\">Verder >></button>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </form>\n" +
    "    </div>\n" +
...
angular.module("orderform/orderform.step2.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("orderform/orderform.step2.tpl.html",
    "<div class=\"panel panel-default rounded\">\n" +
    "    <div class=\"panel-heading\">\n" +
    "        <h1 class=\"panel-title\">Order your success!</h1>\n" +
    "        <small>Step 2</small>\n" +
    ...
    "                    <div class=\"col-sm-3\">\n" +
    "                        <label for=\"aanhefInput\">Aanhef</label>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-sm-2\">\n" +
    "                        <select name=\"aanhefInput\" required type=\"text\" ng-model=\"order.aanhef\"\n" +
    "                                class=\"form-control\" id=\"aanhefInput\">\n" +
    ...
    "                <div class=\"form-group\">\n" +
    "                    <div class=\"col-sm-3\">\n" +
    "                        <label for=\"voorlettersInput\">Voorletter</label>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-sm-6\">\n" +
    "                        <input type=\"text\" class=\"form-control\" id=\"voorlettersInput\" placeholder=\"Voorletter\"\n" +
    "                               ng-model=\"order.voorletters\">\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "\n" +
    ...
    "                <div class=\"form-group\">\n" +
    "                    <div class=\"col-sm-3\">\n" +
    "                        <label for=\"tussenvoegselsInput\">Tussenvoegsels</label>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-sm-6\">\n" +
    "                        <input type=\"text\" class=\"form-control\" id=\"tussenvoegselsInput\" placeholder=\"Tussenvoegsels\"\n" +
    "                               ng-model=\"order.tussenvoegsels\">\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "\n" +
    ...
    "                <div class=\"col-xs-offset-1 col-sm-offset-3 col-xs-11 col-sm-9\">\n" +
    "                    <button type=\"submit\" ng-click=\"back()\" class=\"btn btn-lg btn-success\"><< Back</button>\n" +
    "                    <button type=\"submit\" ng-click=\"next()\" ng-show=\"isValidOrder()\" class=\"btn btn-lg btn-success\">\n" +
    "                        Verder >>\n" +
    "                    </button>\n" +
    "                </div>\n" +
    "            </div>\n" +
...
angular.module("orderform/orderform.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("orderform/orderform.tpl.html",
    "<img src=\"assets/DSC_0013.jpg\" class=\"img-responsive\" alt=\"Responsive image\">\n" +
    "\n" +
    "<br>\n" +
    "<br>\n" +
